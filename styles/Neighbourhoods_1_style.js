var size = 0;
var placement = 'point';
function categories_Neighbourhoods_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'HAZENDAL':
...
var style_Neighbourhoods_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("ofc_sbrb_n");
    var labelText = "";
    size = 0;
...
var style = categories_Neighbourhoods_1(feature, value, size, resolution, labelText,
